    ...
    public List<Animator> createAnimation() {
        ...
        translationAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                translateX = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        ...
        alphaAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                alpha = Integer.parseInt(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        alphaAnim.start();
        ...
        rotateAnim1.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                degrees1 = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        rotateAnim1.start();
        ...
        rotateAnim2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                degrees2 = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        rotateAnim2.start();
