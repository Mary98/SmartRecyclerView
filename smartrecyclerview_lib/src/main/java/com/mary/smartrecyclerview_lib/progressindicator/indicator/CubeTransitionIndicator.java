package com.mary.smartrecyclerview_lib.progressindicator.indicator;
    ...
    public List<Animator> createAnimation() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            translationXAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    translateX[index] = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                    postInvalidate();
                }
            });
            ...
            translationYAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    translateY[index] = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                    postInvalidate();
                }
            });
        ...
        scaleAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                scaleFloat = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        scaleAnim.start();
        ...
        rotateAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                degrees = Float.parseFloat(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        rotateAnim.start();
