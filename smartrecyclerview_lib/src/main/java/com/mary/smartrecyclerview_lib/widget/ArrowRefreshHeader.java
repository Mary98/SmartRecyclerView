package com.mary.smartrecyclerview_lib.widget;
...
import com.mary.smartrecyclerview_lib.config.ProgressStyle;
import com.mary.smartrecyclerview_lib.inter.BaseRefreshHeader;
import com.mary.smartrecyclerview_lib.progressindicator.AVLoadingIndicatorView;
    ...
    private void smoothScrollTo(int destHeight) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                setVisibleHeight(Integer.parseInt(String.valueOf(animation.getAnimatedValue())));
            }
        });
        animator.start();
    }
